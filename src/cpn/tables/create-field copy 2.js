...
export default () => {
  ...
  const handleSubmitModal = () => {
    if (validate()) {
      ...
      if (isOnforenkey) {
        setForeignKeys([
          ...foreignKeys,
          { ...foreignKey, index: tempCounter, cascade: isOnCascade },
        ]);
      }
  ...
  useEffect(() => {
    ...
    if (primaryKey.includes(fieldTempUpdate.index)) {
      setIsOn(true);
      setPrimaryFlicker({ ...primaryFlicker, on: true });
    } else {
      setPrimaryFlicker({ ...primaryFlicker, on: false });
    }
    const fk = foreignKeys.some(
      (fk) =>
        fk.index === fieldTempUpdate.index || fk.field_id === fieldTempUpdate.id
    );
    console.log(fk);
    if (fk) {
      setIsOnforenkey(true);
      setForeignFlicker({ ...foreignFlicker, on: true });
    } else {
      setIsOnforenkey(false);
      setForeignFlicker({ ...foreignFlicker, on: false });
    }

    if (
      foreignKeys.some((fk) => fk.index === fieldTempUpdate.index && fk.cascade)
    ) {
      setIsOnCascade(true);
      setCascadeFlicker({ ...cascadeFlicker, on: true });
    } else {
      setCascadeFlicker({ ...cascadeFlicker, on: false });
      setIsOnCascade(false);
    }
  }, [fieldTempUpdate]);
                ...
                <div class="row column1">
                  <div class="form-group col-lg-4">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setTable({ ...table, table_name: e.target.value })
                      }
                      placeholder=""
                    />
                    {errorTable.table_name && (
                      <p className="text-danger">{errorTable.table_name}</p>
                    )}
                  </div>
                        ...
                        <>
                            ...
                            <tbody>
                              {currentTable.map((field, index) => (
                                <tr key={field.id}>
                                  ...
                                  <td>
                                    {formatDate(field.create_at.toISOString())}
                                  </td>
                                  <td
                                    class="align-center"
                          ...
                          <div className="d-flex justify-content-between align-items-center">
                            <p>
                              ...
                              {Math.min(indexOfLastTable, tempFields?.length)}{" "}
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-lg-12 d-flex align-items-center">
                      ...
                      <div className="flicker-container">
                        ...
                        <div
                          className={`flicker ${
                            primaryFlicker.on ? "flicker-on" : ""
                          } ${primaryFlicker.focus ? "flicker-focus" : ""} `}
                    ...
                    <div class="form-group col-lg-6 d-flex align-items-center">
                      ...
                      <div className="flicker-container">
                        ...
                        <div
                          className={`flicker ${
                            foreignFlicker.on ? "flicker-on" : ""
                          } ${foreignFlicker.focus ? "flicker-focus" : ""} `}
                    ...
                    <div
                      class="form-group col-lg-6 d-flex align-items-center"
                      style={{ opacity: `${isOnforenkey ? 1 : 0}` }}
                    >
                      ...
                      <div className="flicker-container">
                        ...
                        <div
                          className={`flicker ${
                            cascadeFlicker.on ? "flicker-on" : ""
                          } ${cascadeFlicker.focus ? "flicker-focus" : ""} `}
