            ...
            <div class="white_shd full margin_bottom_30">
              <div class="full graph_head">
                <div class="heading1 margin_0 ">
                  <h5>
                    <label class="pointer" onClick={() => navigate(-1)}>
                            ...
                            <tbody>
                              {currentTable.map((field, index) => (
                                <tr key={field.id}>
                                  ...
                                  >
                                    <i
                                      class="fa fa-edit size pointer icon-margin icon-edit"
                                    ...
                                    ></i>
                                    <i
                                      class="fa fa-trash-o size pointer icon-margin icon-delete"
                      ...
                      <div class="table-responsive">
                        {currentFields && currentFields.length > 0 ? (
                          <>
                              ...
                              <tbody>
                                {currentFields.map((field, index) => (
                                  <tr key={field.id}>
                                    ...
                                    <td class="align-center">
                                      {" "}
                                      {primaryKey.includes(field.index) ? (
                                        <img
                                          src="/images/icon/p-key.png"
                                          width={14}
                                          alt="Key"
                                    ...
                                    >
                                      <i
                                        class="fa fa-edit size pointer icon-margin icon-edit"
                                        onClick={() => getIdFieldTempNew(field)}
                                        data-toggle="modal"
                                        data-target="#editFieldTemp"
                                        title={lang["edit"]}
                                      ></i>
                                      <i
                                        class="fa fa-trash-o size pointer icon-margin icon-delete"
                                        onClick={() => deleteFieldTemp(field)}
                                        title={lang["delete"]}
                                      ></i>
                                    </td>
                                  </tr>
                            ...
                            <div className="d-flex justify-content-between align-items-center">
                              <p>
                                {lang["show"]} {indexOfFirstFields + 1}-
                                {Math.min(
                                  indexOfLastFields,
                                  tempFields?.length
                                )}{" "}
                                {lang["of"]} {tempFields?.length}{" "}
                                {lang["results"]}
                              </p>
                              <nav aria-label="Page navigation example">
                                <ul className="pagination mb-0">
                                  <li
                                    className={`page-item ${
                                      currentPageFields === 1 ? "disabled" : ""
                                    }`}
                                  >
                                    <button
                                      className="page-link"
                                      onClick={() =>
                                        paginateFields(currentPageFields - 1)
                                      }
                                    >
                                      &laquo;
                                    </button>
                                  </li>
                                  {Array(totalPagesFields)
                                    .fill()
                                    .map((_, index) => (
                                      <li
                                        className={`page-item ${
                                          currentPageFields === index + 1
                                            ? "active"
                                            : ""
                                        }`}
                                      >
