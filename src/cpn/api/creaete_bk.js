      ...
      (table) =>
        ...
        updatedSelectedTables.some(
          (selectedTable) =>
            ...
            table.foreign_keys.some(
              (fk) =>
                fk.table_id === selectedTable.id ||
                fk.ref_table_id === selectedTable.id
            ) ||
                ...
                <div class="heading1 margin_0 ">
                  <h5>
                    <a onClick={() => navigate(-1)}>
                      <i class="fa fa-chevron-circle-left mr-3"></i>
                    </a>
                    Tạo mới api{" "}
                  </h5>
                </div>
                ...
                <div class="row column1">
                  <div class="form-group col-lg-5">
                    <label class="font-weight-bold">
                      Tên api <span className="red_star">*</span>
                    </label>
                    <input
                      type="text"
                  ...
                  <div class="form-group col-lg-4">
                    <label class="font-weight-bold">
                      Phạm vi <span className="red_star">*</span>
                    </label>
                    <div class="checkbox-group">
                      <div class="checkbox-item">
                        <input
                          ...
                          onChange={() =>
                            setModalTemp({ ...modalTemp, api_scope: "public" })
                          }
                        />
                      ...
                      <div class="checkbox-item">
                        <input
                          ...
                          onChange={() =>
                            setModalTemp({ ...modalTemp, api_scope: "private" })
                          }
                        />
                  ...
                  <div class="form-group col-lg-5">
                    <label class="font-weight-bold">
                      Phương thức <span className="red_star">*</span>
                    </label>
                    <div class="checkbox-group">
                      <div class="checkbox-item">
                        <input
                  ...
                  <div class="col-md-12 col-lg-12 bordered">
                    <div class="d-flex align-items-center mb-1">
                      <p class="font-weight-bold">
                        Danh sách các bảng <span className="red_star"> *</span>{" "}
                      </p>
                      {errorApi.api_name && (
                        <p className="text-danger">{errorApi.api_name}</p>
                      )}
                                ...
                                <table class="table table-striped">
                                  ...
                                  <tbody>
                                    {Object.entries(tableFields).map(
                                      ([tableId, tableInfo]) => {
                                        return selectedFields[tableId]?.map(
                                          (fieldId, index) => {
                                            const fieldInfo =
                                              tableInfo.fields.find(
                              ...
                              <>
                                <table class="table table-striped">
                                  ...
                                  <tbody>
                                    {Object.entries(tableFields).map(
                                      ([tableId, tableInfo]) => {
                                        return selectedFieldsBody[tableId]?.map(
                                          (fieldId, index) => {
                                            const fieldInfo =
                                              tableInfo.fields.find(
                                                (field) => field.id === fieldId
                    ...
                    <>
                      ...
                      {modalTemp.api_method === "get" && (
                        <div class="col-md-12 col-lg-12 bordered">
                          <div class="d-flex align-items-center mb-1">
                            <p class="font-weight-bold">
                              Danh sách các trường tính toán{" "}
                            </p>
                            <button
                              type="button"
                              class="btn btn-primary custom-buttonadd ml-auto"
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form>
                  <div className={`form-group col-lg-12`}>
                    <label>
                      Tên trường <span className="red_star">*</span>
                    </label>
                    <input
                      type="text"
                      class="form-control"
                    ...
                    <div class="table-responsive">
                      {modalTemp.fields && modalTemp.fields.length > 0 ? (
                        <table class="table table-striped">
                          ...
                          <tbody>
                            {Object.values(selectedFieldsModal2)
                              .flat()
                              .map((field, index) => (
                                <tr key={index}>
                                  <td>{index + 1}</td>
                  ...
                  <div className={`form-group col-lg-12`}>
                    <label>
                      Công thức <span className="red_star">*</span>
                    </label>
                    <input
                      type="text"
                      class="form-control"
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form>
                  <div className={`form-group col-lg-12`}>
                    <label>
                      Tên trường thống kê <span className="red_star">*</span>
                    </label>
                    <input
                      type="text"
                      class="form-control"
                  ...
                  <div className={`form-group col-lg-12`}>
                    <label>
                      Chọn trường <span className="red_star">*</span>
                    </label>
                    <select
                      className="form-control"
                      value={field}
