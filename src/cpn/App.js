...
function App() {
  ...
  return (
    <Router>
      <Routes>
        <Route path="/login" element={!_token ? <Login /> : <Navigation Child={Home} />} />
        ...
        <Route
          path="/projects/detail/:project_id/edit"
          element={<Navigation Child={EditProject} />}
        />
        <Route
          path="/projects/detail/:project_id"
          element={<Navigation Child={ProjectDetail} />}
        />
        <Route
          path="/projects/task/:project_id"
          element={<Navigation Child={Tasks} />}
        />
        <Route
          path="/projects/detail/task/:project_id"
          element={<Navigation Child={TaskDetail} />}
        />
        <Route
          path="/projects/:version_id/tables"
          element={<Navigation Child={Tables} />}
        />
        <Route
          path="/projects/:version_id/tables/field"
          element={<Navigation Child={Field} />}
        />
        <Route
          path="/projects/:version_id/table/:table_id"
          element={<Navigation Child={UpdateField} />}
        />
        <Route
          path="/projects/:version_id/table/:table_id/pre_import"
          element={<Navigation Child={Pre_import} />}
        />

        <Route
          path="/projects/:project_id/:version_id/apis"
          element={<Navigation Child={Apis} />}
        />
        <Route
          path="/projects/:project_id/:version_id/apis/create"
          element={<Navigation Child={CreateApi} />}
        />
        <Route
          path="/projects/:project_id/:version_id/apis/update/:api_id"
          element={<Navigation Child={updateApi} />}
        />
        ...
        <Route
          ...
          element={<Navigation Child={ChangePass} />}
        />
        <Route
          path="/notifications"
          element={<Navigation Child={View_Notication} />}
        />
