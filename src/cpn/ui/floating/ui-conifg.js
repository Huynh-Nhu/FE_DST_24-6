    ...
    return (
      <div>
        ...
        <div className="config-content">
          <p>
            Sau khi xác nhận lưu, dữ liệu của bản thiết kế <br /> cũ sẽ bị{" "}
            <b>ghi đè </b> hoàn toàn và <b>không</b> thể <br /> khôi phục lại.{" "}
            <br />
            <br />
            Xin lưu ý.
          </p>
        ...
        <div className="buttons">
          <button className="primary" onClick={saveUI}>
            Lưu
          </button>
        </div>
      </div>
  ...
  const sectionSyncDatabaseAndAPI = () => {
    return (
      <div className="sync-data">
        ...
        <div className="config-content">
          <p>
            Đồng bộ dữ liệu từ các config mới vừa được thay đổi ở module khác có
            liên quan như API, Database ...{" "}
          </p>
        </div>
        <div className="buttons">
          <button className="primary" onClick={syncData}>
            Đồng bộ
          </button>
        </div>
      </div>
    ...
    <div className="floating-box ui-config">
      ...
      <div className="configs-container">
        ...
        <div className="config-container">
          <div className="scrollable-box">{Config}</div>
        </div>
      </div>
    </div>
  );
